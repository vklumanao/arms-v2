...
const badgeVariants = cva(
  "inline-flex items-center rounded-[6px] border px-2 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2",
  {
    variants: {
      variant: {
