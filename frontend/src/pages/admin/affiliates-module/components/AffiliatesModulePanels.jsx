...
export function AffiliatesDirectoryContent({
  ...
  const resultsSummary = filteredRows.length
    ? `Showing ${pagination.start + 1}-${pagination.end} of ${filteredRows.length}`
    : "Showing 0 records.";
  const mobileResultsSummary = `${filteredRows.length} results | Page ${pagination.page}/${pagination.totalPages}`;
              ...
              >
                <CardContent className="p-5">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                      <div className="rounded-md border border-slate-200 bg-slate-200 p-3 text-left">
            ...
            <Table className="min-w-[1240px]">
              <TableHeader className="bg-slate-50">
                <TableRow>
                  ...
                  <TableHead className="w-[128px]">Creative Works</TableHead>
